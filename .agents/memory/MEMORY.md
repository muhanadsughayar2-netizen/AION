...
- [CDP Methods Reference](cdp-methods.md) — full reference: Input (mouse/keyboard/modifiers), Runtime.evaluate, Accessibility.queryAXTree, DOM.getBoxModel, Page.handleFileChooser, per-app typing strategies.
