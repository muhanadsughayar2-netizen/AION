...
### Magic Button & Cards Upgrade (December 2025)
- **Unlimited Prompt Room**: Increased magic button prompt limit to 3000 characters.
- **Premium Magic Cards**: Redesigned as glassmorphism-style cards with:
  - Frosted glass background with subtle cyan glows.
  - Dynamic tone colors (Gold/Green/Red).
  - Risk badges (High/Medium/Low).
  - Staggered animations.
  - Automatic JSON repair for truncated responses.
- **Full Card AI**: Increased AI output to 4096 tokens to allow for massive detailed analyses without truncation.
- **Privacy First**: All prompts and analysis remain 100% client-side.
