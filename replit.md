...
- **Image Studio:** Interactive guided experience in Image mode with 16 visual categories (Wallpaper, Social Media Image, Logo/Icon, Portrait, Landscape, Product Shot, Album Cover, Game Art, Interior Design, Fashion, Food Photography, Animal/Pet, Vehicle, Jewelry/Luxury, Space/Cosmic, Character Design), 16 art styles, 10 color options (pick up to 2), description input, and "Surprise Me" randomizer. All prompts include instruction to avoid text/words in generated images for clean output.
