// Variant 2 — Cobalt Blue #2563EB (deeper, richer)
const BLUE = "#2563EB";
const BG = "#1C1C1E";
const CARD = "#2C2C2E";
const WHITE = "#FFFFFF";
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 8, flex: 1 }}>
      <div style={{
        ...
        fontSize: 22,
        boxShadow: active ? "0 0 10px rgba(255,214,10,0.25)" : `0 0 10px rgba(37,99,235,0.25)`,
      }}>{icon}</div>
...
function Thumb({ n, wide }: { n: number; wide?: boolean }) {
  return (
    <div style={{
      ...
      overflow: "hidden",
      boxShadow: n === 1 ? `0 0 8px rgba(37,99,235,0.35)` : "none",
    }}>
      <div style={{ width: "100%", height: "100%", background: n === 2 ? "linear-gradient(135deg,#1a1a3a,#3a2060,#ff80b5)" : n === 3 ? "linear-gradient(135deg,#0a0a1a,#1a1a3a,#2563EB22)" : n === 4 ? "linear-gradient(135deg,#1a1a1a,#2a2a2a)" : `linear-gradient(135deg,${BG},${CARD})` }} />
    ...
    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100vh", background: "#111", fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif' }}>
      <div style={{ width: 360, background: BG, borderRadius: 20, overflow: "hidden", boxShadow: "0 32px 80px rgba(0,0,0,0.7)", border: "1px solid #2a2a2a" }}>
        ...
        <div style={{ padding: "0 16px 12px", display: "grid", gridTemplateColumns: "1fr 1.2fr 1fr", gap: 8 }}>
          ...
          <button style={{ background: BLUE, border: "none", borderRadius: 8, padding: "10px 4px", color: WHITE, fontSize: 12, fontWeight: 800, cursor: "pointer", boxShadow: `0 4px 18px ${BLUE}66` }}>✦ Send to AI</button>
        ...
        <div style={{ background: "#151515", padding: "8px 16px", display: "flex", alignItems: "center" }}>
          <span style={{ color: "#444", fontSize: 9, fontWeight: 700, letterSpacing: 1 }}>COBALT BLUE · #2563EB</span>
