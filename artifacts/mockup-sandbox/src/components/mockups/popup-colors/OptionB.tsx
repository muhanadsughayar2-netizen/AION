    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '12px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          ...
          <span style={{ fontWeight: 800, fontSize: '16px', color: teal }}>TO AI</span>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: '14px', marginBottom: '10px' }}>
          {[
            ...
            { label: 'SNIP', icon: 'scissors' },
            { label: 'FULL PAGE', icon: 'doc' },
            { label: 'AI', icon: 'star' }
          ].map((btn, i) => (
            <div key={i} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px' }}>
              <span style={{ fontSize: '9px', fontWeight: 700, color: teal, letterSpacing: '1px' }}>{btn.label}</span>
              <div style={{
                width: '56px',
                height: '56px',
                display: 'flex',
      ...
      <div style={{ textAlign: 'center', padding: '30px 0' }}>
        <div style={{ fontSize: '14px', fontWeight: 700, color: teal, marginBottom: '6px' }}>Right-click to begin</div>
      ...
      <div style={{
        ...
        {['Select All', 'Copy Combined', 'Save PNG', 'Export PDF'].map((label, i) => (
          <button key={i} style={{
            flex: 1,
            padding: '8px 4px',
            background: i === 0 ? 'rgba(45,212,191,0.08)' : 'rgba(45,212,191,0.04)',
            border: `1px solid rgba(45,212,191,${i === 0 ? '0.3' : '0.12'})`,
            borderRadius: '8px',
            color: i === 0 ? teal : '#8b949e',
            fontSize: '10px',
            fontWeight: 600,
            cursor: 'pointer'
          }}>{label}</button>
